...
public class StabilizerBar: MonoBehaviour 
{
	...
	public float stabilizierMultiplier = 0.8f;
	//referenz auf den Rigidbody des Autos
	...
	void FixedUpdate()
	{
		...
		if(leftWheel != null && rightWheel != null)
		{
			...
			//die Kraft ist also vorzeichenbehaftet, je nach dem in welcher Schräglage sich das Auto befindet, //die maximal übertragene Kraft soll etwas niedriger 
			//sein als die Stärke (Kraft) der Feder
			float stabilizierForce = (suspensionCompressionLeft - suspensionCompressionRight) * leftWheel.wheelCol.suspensionSpring.spring * stabilizierMultiplier;
